...

{
  dconf.settings = {
    ...
    "org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/spotlight" = {
      name = "GNOME Overview";
      command = "bash -c '${pkgs.dbus}/bin/dbus-send --session --dest=org.gnome.Shell --type=method_call /org/gnome/Shell org.freedesktop.DBus.Properties.Set string:org.gnome.Shell string:OverviewActive variant:boolean:true'";
      binding = "<Ctrl>space";
    };
    ...
    "org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/music" = {
      ...
      command = "bash -c 'wmctrl -x -a com.github.th_ch.youtube_music.com.github.th_ch.youtube_music || youtube-music'";
